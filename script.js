...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showView(viewId) {
        ...
        if (viewId !== 'payments') state.invoiceModalSelections.clear();
    ...
    function attachEventListeners() {
        ...
        const masterDataView = document.getElementById('view-master-data');
        masterDataView.addEventListener('click', e => { if (e.target.classList.contains('btn-edit')) { openEditModal(e.target.dataset.type, e.target.dataset.id); } });
