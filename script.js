    ...
    const refreshViewData = (viewId) => {
        ...
        switch(viewId) {
            ...
            case 'suppliers':
                ...
                populateOptions(document.getElementById('supplier-statement-select'), state.suppliers, 'Select for Statement', 'supplierCode', 'name'); 
                renderPaymentList();
                document.getElementById('supplier-statement-results').style.display = 'none';
            ...
            case 'stock-levels': 
                ...
                document.getElementById('item-inquiry-search').value = ''; 
                renderItemInquiry(''); 
